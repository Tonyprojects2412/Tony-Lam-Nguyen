...
const Blog = () => {
  ...
  const categories = [
    { name: "AI Strategy", count: 3 },
    { name: "Business", count: 5 },
    { name: "Healthcare", count: 2 },
    { name: "AI Implementation", count: 4 },
          ...
          <div className="container-custom">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-gray-600 mb-6">
                Get the latest insights on business strategy and AI implementation delivered to your inbox.
              </p>
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  type="email"
                  placeholder="Enter your email address"
                  className="flex-grow px-4 py-3 rounded-md border border-gray-300 focus:ring-2 focus:ring-primary focus:outline-none"
                />
